...
export const startLogin = (placementRole: "candidate" | "recruiter" = "candidate", flow: "signIn" | "signUp" = "signIn") => {
  ...
  const state = encodeOAuthState({ redirectUri, nonce, placementRole });
